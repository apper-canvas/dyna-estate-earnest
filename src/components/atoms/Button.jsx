...
const Button = ({
  ...
  const variants = {
    primary: 'bg-accent text-white hover:bg-accent/90 focus:ring-accent/50 shadow-sm hover:shadow-md',
    ...
    ghost: 'text-gray-600 hover:text-primary hover:bg-surface-50 focus:ring-primary/50',
